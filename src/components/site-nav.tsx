...
export function SiteNav() {
  ...
  return (
    <nav
      className="fixed left-1/2 z-50 w-[min(1100px,95vw)] -translate-x-1/2 border border-[var(--border-visible)] bg-[rgba(8,8,5,0.92)] px-2 py-2 [clip-path:polygon(0_0,calc(100%-18px)_0,100%_18px,100%_100%,18px_100%,0_calc(100%-18px))] sm:px-3"
