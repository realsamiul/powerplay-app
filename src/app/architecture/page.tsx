...
export default function ArchitecturePage() {
  ...
  return (
    <div className="relative overflow-hidden pb-24">
      ...
      <section className="relative z-10 mx-auto mt-16 max-w-[1700px] px-4 sm:px-8 md:px-12 lg:px-16">
            ...
            return (
              <article key={section.title} className="border-b border-[var(--border-subtle)]">
                <button
                  ...
                  className="w-full cursor-pointer px-1 py-6 text-left"
                  ...
                  {open ? (
                    ...
                    >
                      <div className="border-l-2 border-[var(--accent)] pb-8 pl-6 pr-4 pt-4">
                        <p className="text-base leading-8 text-[var(--fg-muted)]">{section.tech}</p>
